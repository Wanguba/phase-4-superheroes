...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:////home/wanguba/python-code-challenge-superheroes/python-code-challenge-superheroes/code-challenge/app/instance/app.db'
